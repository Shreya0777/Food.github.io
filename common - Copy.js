...
$(window).scroll(function() {
  ...
  var headerHeight = $(".top-ordercat").outerHeight();
  // var firstSection = $(".main-content section:nth-of-type(1)").outerHeight();
  if (header > headerHeight) {
    $(".top-ordercat").addClass("fixed");
  } else {
    $(".top-ordercat").removeClass("fixed");
  }
...
$('.li-cart-header .close').click(function(){
         ...
         $('.li-cart-summary-wrapper').removeClass("humburger-menu");
    });
...
document.addEventListener('click', function(e){
 ...
 $(".humburger-menu").on('click', function(e){
    $('.whole-side').css("display", "block");
});  
$(".side-arrow").on('click', function(e){
    $('.whole-side').css("display", "none");
}); 
